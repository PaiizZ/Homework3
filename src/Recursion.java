...
/**
 * Recursion class contain unique method that remove duplicate consecutive items from a list.
 *
...
public class Recursion {
    ...
    public static List unique(List list){
        ...
        if( list.get(0).equals(list.get(1)) ) { list.remove(0); unique( list ); }
        else unique( list.subList(1,list.size()) );
        return list;
    }

    /**
     * Main for test unique method.
     */
